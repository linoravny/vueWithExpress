...
const mockProductsList = [
  {
    ...
    "cogs":{"unitManufacturingCost":3722,"shipmentUnitCost":6,"monthlyAdvertismentCost":4271,"manufacturingCountry":"AZ",},
    "editMode":false
  },
  {
    "id": "B07DR3LS7Y",
    ...
    "cogs": {
      "unitManufacturingCost": 12,
      "shipmentUnitCost": 13,
      "monthlyAdvertismentCost": 14,
      "manufacturingCountry": "AZ",
    },
    "editMode":false
  },
]
...
beforeEach(async () => {
  ...
  await wrapper.setData({ countries: mockCountriesList,products: mockProductsList })
});
